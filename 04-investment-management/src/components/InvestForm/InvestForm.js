        ...
        <form onSubmit={submitHandler} className={styles.form}>
            <div className={styles['input-group']}>
                <p>
                    ...
                    <input
                        onChange={(event) => onChangeHandler('current-savings', event.target.value)}
                ...
                <p>
                    ...
                    <input
                        onChange={(event) => onChangeHandler('yearly-contribution', event.target.value)}
            ...
            <div className={styles['input-group']}>
                <p>
                    ...
                    <input
                        onChange={(event) => onChangeHandler('expected-return', event.target.value)}
